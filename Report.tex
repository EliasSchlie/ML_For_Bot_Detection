...
\begin{table}[H]
\centering
\caption{10 most important features for XGBoost predictions based on their }
\label{tab:xgb_feature_importance}
\begin{tabular}{lr}
\toprule
 & 0 \\
\midrule
has\_photo\_0.0 & 741.480 \\
has\_mobile\_Unknown & 366.661 \\
has\_status\_Unknown & 354.188 \\
all\_posts\_visible\_Unknown & 232.566 \\
subscribers\_count & 37.060 \\
avg\_likes & 33.168 \\
city\_Saint Petersburg & 27.401 \\
has\_website\_0.0 & 26.403 \\
has\_occupation & 18.723 \\
has\_status\_0.0 & 16.661 \\
\bottomrule
\end{tabular}
\end{table}
